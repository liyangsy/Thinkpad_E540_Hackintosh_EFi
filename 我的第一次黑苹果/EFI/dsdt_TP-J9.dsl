ACPI Error (dmutils-0262): Argument count mismatch for method \_SB_.PCI0.VID_.GLIS 2 1 [20081204]
ACPI Error (dmutils-0262): Argument count mismatch for method \_SB_.PCI0.VID_.GLIS 2 1 [20081204]
ACPI Error (dmutils-0262): Argument count mismatch for method \_SB_.PCI0.VID_.GLIS 2 1 [20081204]
ACPI Error (dmutils-0262): Argument count mismatch for method \_SB_.PCI0.VID_.GLIS 2 1 [20081204]
/*
 ...
 *
 * Disassembly of (null), Wed Nov 20 22:10:21 2019
 *
 *
 ...
 */
DefinitionBlock ("DSDT.aml", "DSDT", 1, "LENOVO", "TP-J9   ", 0x00002160)
{
    External (NDL8)
    External (NDL7)
    External (NDL6)
    ...
    External (PDC0)
    External (\_SB_.PCCD)
    External (\_SB_.IAOE.GSWR)
    External (\_SB_.IAOE.GAOS)
    External (\_PR_.CPU0._PSS, IntObj)
    External (\_SB_.PCCD.PENB)
    External (\_SB_.PCI0.VID_.GSCI, MethodObj)    // 0 Arguments
    External (\_SB_.PCI0.VID_.GSSE, MethodObj)    // 1 Arguments
    External (\_SB_.PCI0.VID_.STAT)
    External (\_SB_.PCI0.VID_.TCHE)
    External (\_SB_.PCI0.VID_.AINT, MethodObj)    // 2 Arguments
    External (\_SB_.PCI0.VID_.DRDY, MethodObj)    // 6 Arguments
    External (\_SB_.PCI0.SAT1.PRT2)
    External (\_SB_.PCI0.VID_.GLIS, MethodObj)    // 2 Arguments
    ...
    OperationRegion (OEMN, SystemMemory, 0xBCF4AF98, 0x0014)
    ...
    OperationRegion (GNVS, SystemMemory, 0xBCF4BC18, 0x02B0)
    ...
    Scope (\_SB)
    {
        ...
        Device (PCI0)
        {
            ...
            Device (SMBU)
            {
                ...
                Device (NFC)
                {
                    Name (_HID, EisaId ("BCM2F09"))
                    Name (_CID, EisaId ("BCM2F09"))
                    Name (_UID, 0x00)
                    Method (_STA, 0, NotSerialized)
                    {
                        Return (0x00)
                ...
                Device (URTH)
                {
                    ...
                    Device (SSP5)
                    {
                        ...
                        Method (_UPC, 0, Serialized)
                        {
                            ...
                            CopyObject (\UPCN, UPCP)
                            If (LOr (LNot (And (PR2, 0x20)), LNot (And (PR3, 
                                0x20))))
                            {
                                Store (0x00, Index (UPCP, 0x00))
                            }
                    ...
                    Device (URMH)
                    {
                        ...
                        Device (PRT8)
                        {
                            ...
                            Method (_UPC, 0, Serialized)
                            {
                                ...
                                Else
                                {
                                    If (And (\_SB.PCI0.XHCI.PR2, 0x0100))
                                    {
                                        Store (0x00, Index (UPCP, 0x00))
                                    }
                                }
                        ...
                        Device (PRT9)
                        {
                            ...
                            Method (_UPC, 0, Serialized)
                            {
                                ...
                                Else
                                {
                                    If (And (\_SB.PCI0.XHCI.PR2, 0x0200))
                                    {
                                        Store (0x00, Index (UPCP, 0x00))
                                    }
                                }
                        ...
                        Device (PRTA)
                        {
                            ...
                            Method (_UPC, 0, Serialized)
                            {
                                ...
                                Else
                                {
                                    If (And (\_SB.PCI0.XHCI.PR2, 0x0400))
                                    {
                                        Store (0x00, Index (UPCP, 0x00))
                                    }
                                }
                        ...
                        Device (PRTB)
                        {
                            ...
                            Method (_UPC, 0, Serialized)
                            {
                                ...
                                Else
                                {
                                    If (And (\_SB.PCI0.XHCI.PR2, 0x0800))
                                    {
                                        Store (0x00, Index (UPCP, 0x00))
                                    }
                                }
                        ...
                        Device (PRTC)
                        {
                            ...
                            Method (_UPC, 0, Serialized)
                            {
                                ...
                                Else
                                {
                                    If (And (\_SB.PCI0.XHCI.PR2, 0x1000))
                                    {
                                        Store (0x00, Index (UPCP, 0x00))
                                    }
                                }
                        ...
                        Device (PRTD)
                        {
                            ...
                            Method (_UPC, 0, Serialized)
                            {
                                ...
                                Else
                                {
                                    If (And (\_SB.PCI0.XHCI.PR2, 0x2000))
                                    {
                                        Store (0x00, Index (UPCP, 0x00))
                                    }
                                }
        ...
        Scope (\_SB.PCI0.LPC.EC)
        {
            ...
            Method (BRNS, 0, NotSerialized)
            {
                ...
                Store (\BRTN, Local3)
                If (\_SB.PCI0.VID.DRDY (If (LEqual (0x00, Local0))
                        {
                        ...
                        }, Else
                        {
                            ...
                            Store (DerefOf (Index (DerefOf (Index (BRTB, Local3)), 0x13)), 
                                Local2)
                        }, Or (Local1, ShiftLeft (Local2, 0x09), Local2), \_SB.PCI0.VID.AINT (0x03, Local2), 
                    ...
                    If (\VIGD)
                    {
                        If (And (\_SB.PCI0.VID.TCHE, 0x0100))
                        {
                            If (And (\_SB.IAOE.GAOS, 0x01))
                            {
                                ...
                                {
                                    Store (Or (And (\_SB.PCI0.VID.STAT, Not (0x03)), 0x01), 
                                        \_SB.PCI0.VID.STAT)
            ...
            \_SB.PCI0.VID.GLIS (\_SB.LID._LID (), Else
                {
                    If (\WVIS)
                    {
                        \_SB.PCI0.VID.GLIS (\_SB.LID._LID (), If (LLess (Arg0, 0x04))
                            {
                                If (And (\RRBF, 0x02))
                                {
